...
class Robinson {
                            ...
                            if (err) {
                                ...
                                await tempoWB.xlsx.readFile(`./output/tempo_sheet.xlsx`).then(() => {
                                    ...
                                    tempoSheet.eachRow({includeEmpty: false }, (row, rowNumber) => {
                                        if (rowNumber !== 1) {
                                            // tempoWBUpdateSheet[`K${rowNumber}`] = { t: 'n', f: `VLOOKUP(G${rowNumber},Sku_Consolidated!A2:G${consolidatedSheet.lastRow.number},7, FALSE)`}
                                            // tempoWBUpdateSheet[`L${rowNumber}`] = { t: 'n', f: `VLOOKUP(G${rowNumber},Sku_Consolidated!A2:G${consolidatedSheet.lastRow.number},7, FALSE)`}
                                            // tempoWBUpdateSheet[`M${rowNumber}`] = { t: 'n', f: `VLOOKUP(G${rowNumber},Sku_Consolidated!A2:G${consolidatedSheet.lastRow.number},7, FALSE)`}
                                            ...
                                            // tempoWBUpdateSheet[`T${rowNumber}`] = { t: 'n', f: `VLOOKUP(G${rowNumber},Sku_Consolidated!A2:G${consolidatedSheet.lastRow.number},7, FALSE)`}
                                            // tempoWBUpdateSheet[`V${rowNumber}`] = { t: 'n', f: `VLOOKUP(G${rowNumber},Sku_Consolidated!A2:G${consolidatedSheet.lastRow.number},7, FALSE)`}
                                            // tempoWBUpdateSheet[`W${rowNumber}`] = { t: 'n', f: `VLOOKUP(G${rowNumber},Sku_Consolidated!A2:G${consolidatedSheet.lastRow.number},7, FALSE)`}
                                            // tempoWBUpdateSheet[`X${rowNumber}`] = { t: 'n', f: `VLOOKUP(G${rowNumber},Sku_Consolidated!A2:G${consolidatedSheet.lastRow.number},7, FALSE)`}
                                            // tempoWBUpdateSheet[`Y${rowNumber}`] = { t: 'n', f: `VLOOKUP(G${rowNumber},Sku_Consolidated!A2:G${consolidatedSheet.lastRow.number},7, FALSE)`}
                                            // tempoWBUpdateSheet[`AA${rowNumber}`] = { t: 'n', f: `VLOOKUP(G${rowNumber},Sku_Consolidated!A2:G${consolidatedSheet.lastRow.number},7, FALSE)`}
                                            // tempoWBUpdateSheet[`AB${rowNumber}`] = { t: 'n', f: `VLOOKUP(G${rowNumber},Sku_Consolidated!A2:G${consolidatedSheet.lastRow.number},7, FALSE)`}
                                            // tempoWBUpdateSheet[`AC${rowNumber}`] = { t: 'n', f: `VLOOKUP(G${rowNumber},Sku_Consolidated!A2:G${consolidatedSheet.lastRow.number},7, FALSE)`}
                                        }
                                    })
    ...
    duplicateSheetData(targetFile) {
        ...
        const srpData = XLSX.utils.sheet_to_json(srpSheet);
        const vamData = XLSX.utils.sheet_to_json(vamSheet);
        const consolidatedData = XLSX.utils.sheet_to_json(consolidatedSheet);
        const commrateData = XLSX.utils.sheet_to_json(commrateSheet);
        const ninersData = XLSX.utils.sheet_to_json(ninersSheet);
